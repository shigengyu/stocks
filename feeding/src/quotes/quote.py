...
class EodQuote(object):
    ...
    def from_line(symbol, line):
        elements = line.split(",")
        return EodQuote(symbol, elements[0], elements[1], elements[2], elements[3], elements[4], elements[5], elements[6])
...
class EodQuoteTests(unittest.TestCase):
    ...
    def test_from_line(self):
        quote = EodQuote.from_line("300460.SZ", "2015-05-22,88.80,96.57,86.10,96.57,22140100,96.57")
